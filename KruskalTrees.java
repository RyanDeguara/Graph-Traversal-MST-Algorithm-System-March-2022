...
{ //start Heap
    ...
    // heap constructor that gets passed from the graph
...
class UnionFindSets
{ //start union find data structure class

    private int[] treeParent;
    private int N;
    
    public UnionFindSets( int V)
    { //start union find data constructor
    ...
    //from this set that serves as its ‘representative’ by travelling back the tree from 
    //vertex u until the root is found.
    public int findSet( int vertex)
    { //start findSet operation
...
**********************************************************/
    ...
    { //start MST_Kruskal algorithm operation
